...
public class NodoCategoria {
    ...
    public NodoCategoria getPadre() { return padre; }
    public void setPadre(NodoCategoria padre) { this.padre = padre; }
    
    public List<NodoCategoria> getHijos() { return hijos; }
    public void setHijos(List<NodoCategoria> hijos) { this.hijos = hijos; }
